...
const file_admin_admin_proto_rawDesc = "" +
	"\n" +
	"\x11admin/admin.proto\x12\x05admin\x1a\x1bgoogle/protobuf/empty.proto\"-\n" +
	"\fSetupRequest\x12\x1d\n" +
	"\n" +
	"rootfs_url\x18\x01 \x01(\tR\trootfsUrl\"\x0e\n" +
	"\fCleanRequest2s\n" +
	"\x05Admin\x124\n" +
	"\x05Setup\x12\x13.admin.SetupRequest\x1a\x16.google.protobuf.Empty\x124\n" +
	"\x05Clean\x12\x13.admin.CleanRequest\x1a\x16.google.protobuf.EmptyBn\n" +
	",io.agentsandbox.packages.sandboxd.spec.adminP\x01Z<sigs.k8s.io/agent-sandbox/packages/sandboxd/spec/admin;adminb\x06proto3"
...
var file_admin_admin_proto_goTypes = []any{
	(*SetupRequest)(nil),  // 0: admin.SetupRequest
	(*CleanRequest)(nil),  // 1: admin.CleanRequest
	(*emptypb.Empty)(nil), // 2: google.protobuf.Empty
}
var file_admin_admin_proto_depIdxs = []int32{
	0, // 0: admin.Admin.Setup:input_type -> admin.SetupRequest
	1, // 1: admin.Admin.Clean:input_type -> admin.CleanRequest
	2, // 2: admin.Admin.Setup:output_type -> google.protobuf.Empty
	2, // 3: admin.Admin.Clean:output_type -> google.protobuf.Empty
