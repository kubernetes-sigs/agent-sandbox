...
func (r *SandboxClaimReconciler) validateAdditionalPodMetadata(ctx context.Context, claimMeta *v1alpha1.PodMetadata) error {
	if claimMeta == nil {
		return nil
	}
...
func (r *SandboxClaimReconciler) getOrCreateSandbox(ctx context.Context, claim *extensionsv1alpha1.SandboxClaim, _ *extensionsv1alpha1.SandboxTemplate) (*v1alpha1.Sandbox, error) {
	...
	sbName := ""
	if claim.Labels != nil {
		sbName = claim.Labels[extensionsv1alpha1.AssignedSandboxNameLabel]
	}
	if sbName != "" {
