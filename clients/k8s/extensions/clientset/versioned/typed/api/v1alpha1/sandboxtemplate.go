...
type SandboxTemplateInterface interface {
	...
	ApplyStatus(ctx context.Context, sandboxTemplate *applyconfigurationapiv1alpha1.SandboxTemplateApplyConfiguration, opts v1.ApplyOptions) (result *apiv1alpha1.SandboxTemplate, err error)
