...
//go:generate go tool -modfile=tools.mod sigs.k8s.io/controller-tools/cmd/controller-gen paths="./..." output:rbac:dir=k8s rbac:roleName=agent-sandbox-controller,fileName=rbac.yaml
