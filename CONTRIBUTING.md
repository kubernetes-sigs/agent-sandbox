...
- **AI-Assisted Code Reviews:** We use GitHub Copilot to provide automated, first-pass code reviews to help identify low-hanging fruit and improve review velocity.
  ...
  - **AI Agent Skills:** We provide instructions for AI agents in the [`.agent/skills/`](.agent/skills/) directory. These skills guide AI assistants to follow project conventions and rules. Contributors using AI tools are encouraged to reference these skills.
