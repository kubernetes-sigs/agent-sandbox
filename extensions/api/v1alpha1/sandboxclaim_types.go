...
const (
	...
	// The underlying SandboxClaim resources (Pod, Service) are deleted to save resources,
...
type Lifecycle struct {
	...
	// This time governs the lifecycle of the claim. It is propagated to the
	// underlying Sandbox, overriding any expiration logic defined there.
	//
	// Updates are allowed and if this field is updated to be omitted (nil),
	// the existing ShutdownTime is preserved.
