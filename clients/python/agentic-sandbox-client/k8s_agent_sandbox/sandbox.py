...
from .commands.command_execution import CommandExecution
...
class Sandbox:
    ...
    - Executing commands via the `core` property.
    - Managing files via the `files` property.
    - Handling the underlying connection and authentication.
    ...
    def __init__(
        ...
        self._commands = CommandExecution(self.connector, self.tracer, self.trace_service_name)
    ...
    @property
    def commands(self) -> CommandExecution | None:
