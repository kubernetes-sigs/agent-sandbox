...
func (in *EgressRule) DeepCopyInto(out *EgressRule) {
	*out = *in
	if in.ToIPBlock != nil {
		...
		*out = new(IPBlockWithExcept)
		(*in).DeepCopyInto(*out)
	}
	if in.ToPodSelector != nil {
		in, out := &in.ToPodSelector, &out.ToPodSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.InNamespaceSelector != nil {
		in, out := &in.InNamespaceSelector, &out.InNamespaceSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPBlockWithExcept) DeepCopyInto(out *IPBlockWithExcept) {
	*out = *in
	if in.Except != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPBlockWithExcept.
func (in *IPBlockWithExcept) DeepCopy() *IPBlockWithExcept {
	if in == nil {
		return nil
	}
	out := new(IPBlockWithExcept)
...
func (in *IngressRule) DeepCopyInto(out *IngressRule) {
	*out = *in
	if in.FromPodSelector != nil {
		in, out := &in.FromPodSelector, &out.FromPodSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *NetworkPolicySpec) DeepCopyInto(out *NetworkPolicySpec) {
	*out = *in
	if in.IngressControllerSelectors != nil {
		in, out := &in.IngressControllerSelectors, &out.IngressControllerSelectors
		*out = new(IngressSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.IngressFromIPBlocks != nil {
		in, out := &in.IngressFromIPBlocks, &out.IngressFromIPBlocks
