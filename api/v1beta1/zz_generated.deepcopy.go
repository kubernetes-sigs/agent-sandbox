...
func (in *AutoSuspendPolicy) DeepCopyInto(out *AutoSuspendPolicy) {
	*out = *in
	if in.InactivityDuration != nil {
		in, out := &in.InactivityDuration, &out.InactivityDuration
		*out = new(v1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoSuspendPolicy.
func (in *AutoSuspendPolicy) DeepCopy() *AutoSuspendPolicy {
	if in == nil {
		return nil
	}
	out := new(AutoSuspendPolicy)
	in.DeepCopyInto(out)
	return out
}
