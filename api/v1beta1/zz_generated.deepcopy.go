...
func (in *AutoSuspensionPolicy) DeepCopyInto(out *AutoSuspensionPolicy) {
	*out = *in
	if in.InactivityTimeoutSeconds != nil {
		in, out := &in.InactivityTimeoutSeconds, &out.InactivityTimeoutSeconds
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoSuspensionPolicy.
func (in *AutoSuspensionPolicy) DeepCopy() *AutoSuspensionPolicy {
	if in == nil {
		return nil
	}
	out := new(AutoSuspensionPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Lifecycle) DeepCopyInto(out *Lifecycle) {
	*out = *in
	...
	if in.AutoSuspension != nil {
		in, out := &in.AutoSuspension, &out.AutoSuspension
		*out = new(AutoSuspensionPolicy)
		(*in).DeepCopyInto(*out)
	}
}
