...
func (r *SandboxClaimReconciler) recordClaimStartupLatency(ctx context.Context, claim *extensionsv1beta1.SandboxClaim, launchType string, warmPoolName string) {
	logger := log.FromContext(ctx)
	...
	asmetrics.RecordClaimStartupLatency(webhookSeenTime, launchType, warmPoolName)
}

// recordControllerStartupLatency records the controller startup latency based on observed time.
func (r *SandboxClaimReconciler) recordControllerStartupLatency(ctx context.Context, claim *extensionsv1beta1.SandboxClaim, launchType string, warmPoolName string) {
	logger := log.FromContext(ctx)
	if observedTimeString := claim.Annotations[asmetrics.ObservabilityAnnotation]; observedTimeString != "" {
		...
		asmetrics.RecordClaimControllerStartupLatency(observedTime, launchType, warmPoolName)
	}
}
...
func (r *SandboxClaimReconciler) recordCreationLatencyMetric(
	...
	r.recordClaimStartupLatency(ctx, claim, launchType, warmPoolName)
	r.recordControllerStartupLatency(ctx, claim, launchType, warmPoolName)
