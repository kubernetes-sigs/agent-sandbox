...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SandboxLifecycleStatus) DeepCopyInto(out *SandboxLifecycleStatus) {
	*out = *in
	if in.FirstObservedTime != nil {
		in, out := &in.FirstObservedTime, &out.FirstObservedTime
		*out = (*in).DeepCopy()
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SandboxLifecycleStatus.
func (in *SandboxLifecycleStatus) DeepCopy() *SandboxLifecycleStatus {
	if in == nil {
		return nil
	}
	out := new(SandboxLifecycleStatus)
	in.DeepCopyInto(out)
	return out
}
