...
class TestSandbox(unittest.TestCase):
    ...
    @patch('k8s_agent_sandbox.sandbox.CommandExecution')
    ...
    def setUp(self, mock_k8s_helper, mock_connector, mock_create_tracer_manager, mock_command_execution, mock_filesystem):
        ...
        self.mock_command_execution_cls = mock_command_execution
        ...
        self.mock_command_execution = mock_command_execution.return_value
    ...
    def test_init_with_defaults(self):
        ...
        self.mock_command_execution_cls.assert_called_once_with(self.mock_connector, self.mock_tracer, 'sandbox-client')
    ...
    @patch('k8s_agent_sandbox.sandbox.SandboxConnector')
    @patch('k8s_agent_sandbox.sandbox.K8sHelper')
    def test_init_with_custom_args(self, mock_k8s_helper, mock_connector, mock_create_tracer_manager, mock_command_execution, mock_filesystem):
        ...
        mock_command_execution.assert_called_once_with(mock_connector.return_value, mock_tracer, "custom-tracer")
    ...
    def test_properties(self):
        ...
        self.assertEqual(self.sandbox.commands, self.mock_command_execution)
