...
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v/#condition-v1-meta) array_ | conditions represent the latest available observations of the pool's state.<br />Known condition types are "Available". |  | Optional: \{\} <br /> |
