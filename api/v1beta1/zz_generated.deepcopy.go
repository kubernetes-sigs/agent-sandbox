...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdleLifecyclePolicy) DeepCopyInto(out *IdleLifecyclePolicy) {
	*out = *in
	if in.ActiveExpirationPolicy != nil {
		in, out := &in.ActiveExpirationPolicy, &out.ActiveExpirationPolicy
		*out = new(IdleExpirationPolicy)
		**out = **in
	}
	if in.SuspendedTTLSeconds != nil {
		in, out := &in.SuspendedTTLSeconds, &out.SuspendedTTLSeconds
		*out = new(int32)
		**out = **in
	}
	if in.SuspendedExpirationPolicy != nil {
		in, out := &in.SuspendedExpirationPolicy, &out.SuspendedExpirationPolicy
		*out = new(SuspendedExpirationPolicy)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdleLifecyclePolicy.
func (in *IdleLifecyclePolicy) DeepCopy() *IdleLifecyclePolicy {
	if in == nil {
		return nil
	}
	out := new(IdleLifecyclePolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SandboxSpec) DeepCopyInto(out *SandboxSpec) {
	*out = *in
	...
	if in.IdleLifecycle != nil {
		in, out := &in.IdleLifecycle, &out.IdleLifecycle
		*out = new(IdleLifecyclePolicy)
		(*in).DeepCopyInto(*out)
	}
}
