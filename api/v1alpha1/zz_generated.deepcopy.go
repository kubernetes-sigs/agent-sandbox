...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SandboxWarmPoolStrategy) DeepCopyInto(out *SandboxWarmPoolStrategy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SandboxWarmPoolStrategy.
func (in *SandboxWarmPoolStrategy) DeepCopy() *SandboxWarmPoolStrategy {
	if in == nil {
		return nil
	}
	out := new(SandboxWarmPoolStrategy)
	in.DeepCopyInto(out)
	return out
}
