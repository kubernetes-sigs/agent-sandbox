...
func hasWorkspaceResourceOverrides(claim *extensionsv1alpha1.SandboxClaim) bool {
...
func (r *SandboxClaimReconciler) adoptSandboxFromCandidates(ctx context.Context, claim *extensionsv1alpha1.SandboxClaim) (*v1alpha1.Sandbox, error) {
	...
	for range 3 {
		...
		success, err := func() (bool, error) {
			...
			// Apply per-claim workspace container resource overrides before patching the adopted sandbox (fork extension).
